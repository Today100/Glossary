...
##pickle_out = open("accounts", "wb")
##pickle.dump(accounts, pickle_out)
##pickle_out.close()

pickle_in = open("accounts", "rb")
    ...
    while creating == True:
        ...
        if new_u in accounts["user"]:
            ...
            if s == "y":
                ...
                with open("accounts", "wb") as pic:
                    pickle.dump(accounts, pic)
                creating = False
                login_u()
                return
            elif s == "n":
                accounts["user"].pop(new_u)
    ...
    while creating == True:
        ...
        if new_a in accounts["admin"]:
            ...
            if s == "y":
                ...
                with open("accounts", "wb") as pict:
                    pickle.dump(accounts, pict)
